...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.roles.edit', $role->id)->with(['flash_type' => 'success', 'flash_message' => 'Role created successfully', 'flash_description' => $role->title]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.roles.edit', $id)->with(['flash_type' => 'success', 'flash_message' => 'Role updated successfully', 'flash_description' => $role->title]);
    }
}
